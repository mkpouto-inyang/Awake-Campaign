...
const JoinTheMovementLayout = () => {
  const tabClasses = ({ isActive }) =>
    `px-6 py-2 rounded-full text-[12px] md:text-sm font-medium transition-all duration-300 ${
      isActive
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pb-10 py-[80px]">
      {/* Callout Badge */}
      {/* <div className="mt-[48px] text-[11px] lgxl:text-base w-fit flex gap-1 mx-auto border border-orange px-5 py-1 rounded-full justify-center items-center mb-[40px]">
        <img
          src={clock}
          alt="clock icon"
