...
<section className="bg-[#E4F8F3]/70 pt-[80px] pb-[100px] px-4">
  <div className="max-w-[1200px] mx-auto">
    ...
    <p className="text-[12px] md:text-[14px] lg:text-[18px] max-w-4xl text-[#4A5565] text-center mx-auto mb-10">
    ...
    <div className="flex flex-wrap justify-center gap-6 lg:gap-10 mt-10 md:mt-20">
      {/* Donate Card */}
      <div className="bg-white shadow-md rounded-[10px] w-[320px] lg:w-[360px] p-6 flex flex-col justify-between min-h-[350px]">
      ...
      {/* Share Story Card */}
      <div className="bg-white shadow-md rounded-[10px] w-[320px] lg:w-[360px] p-6 flex flex-col justify-between min-h-[370px]">
        <div className="flex flex-col items-center gap-5">
          <div className="bg-[#D5F5EC] rounded-full p-3">
