  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center">
        <h1 className="font-bold text-[20px] md:text-[38px] mdlg:text-[40px] lg:text-[50px] text-blue-dark text-center mb-4 lg:mb-10 autoShow">
      ...
      <div className="hidden md:flex mt-14 flex-wrap justify-center gap-x-[20px] lg:gap-x-[44px] gap-y-10 max-w-6xl mx-auto ">
        {/* Awareness */}
        <div className="relative p-6 md:p-10 lg:p-12 shadow-xl bg-white rounded-[12px] text-center flex-[1_0_300px] max-w-[360px] lg:max-w-[540px] lg:min-h-[220px] autoScaleIn">
        ...
        {/* Prevention */}
        <div className="relative p-6 md:p-10 shadow-xl bg-white rounded-[12px] text-center flex-[1_0_300px] max-w-[360px] lg:max-w-[540px] lg:min-h-[220px] autoScaleIn">
