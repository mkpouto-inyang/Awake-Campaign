const ProblemSection = () => {
  return (
    <div className="px-[16px] md:px-[24px] bg-blue-dark text-white py-[60px] md:py-[80px] lg:py-[130px] ">
      ...
      <p className="text-[12px] smd:text-[13px] md:text-[14px] lg:text-[16px] xl:text-[18px] max-w-6xl  text-text-grey-light leading-relaxed text-center mt-6 lg:mt-4 px-2 xl:px-0 mx-auto mb-12 md:mb-20">
      ...
      <div className="mt-10 mb-10 flex flex-wrap justify-center gap-x-[20px] lg:gap-x-[44px] gap-y-8 max-w-6xl mx-auto">
        <div className="p-5 md:p-[40px] shadow-md bg-white rounded-[8px] text-center flex-[1_0_250px] max-w-[340px]">
      ...
      <div className="max-w-4xl flex flex-col items-center mx-auto bg-teal-dark py-7 lg:px-10 rounded-[8px] lg:mt-20">
