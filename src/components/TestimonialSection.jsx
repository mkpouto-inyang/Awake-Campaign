    ...
    <section className="px-4 py-12 md:py-20 max-w-5xl mx-auto">
      ...
      <div className="text-center mb-10 md:mb-16">
        ...
        <p className="text-[12px] md:text-[14px] lg:text-[18px] text-[#4A5565] max-w-3xl mx-auto">
          Hear from individuals whose lives have been touched by awareness, screening, and the power of sharing their voice.
        </p>
      </div>
        ...
        >
          {testimonials.map((item, index) => (
            <SwiperSlide key={index}>
              <div className="bg-white rounded-md shadow-md p-6 relative min-h-[260px]">
                <div className="absolute left-0 top-6 bottom-6 w-1 bg-teal-400 rounded-r"></div>
      ...
      <div className="hidden md:flex flex-col gap-10">
        {testimonials.map((item, index) => (
          <div
            key={index}
            className="bg-white rounded-md shadow-md p-8 relative"
          >
            <div className="absolute left-0 top-6 bottom-6 w-1 bg-teal-400 rounded-r"></div>
