...
//     googleMapsApiKey: "AIzaSyAlKepURdy110J3yEQJ4gTAPsX83iCZweY",
//     libraries: ["places"]
//   })
...
//       {/* Use Current Location Button (hide after data fetched) */}
...
//           <div className="h-6 w-6 border-4 border-teal-500 border-t-transparent rounded-full spinner" />
//         </div>
//       )}
...
//       {/* No Results */}
//       {/* {!loading && screeningResults.length === 0 && location && (
//         <p className="text-center text-gray-500">
//           No screening centres found near you.
//         </p>
//       )} */}
...
//   const { isLoaded } = useJsApiLoader({
//     id: "google-map-script",
//     googleMapsApiKey:"AIzaSyCPe_yFtoOHqpDAbVXgNa8xdaPuiORCNYc",
//     libraries: ["places"],
//   });
...
//       if (!data.places) throw new Error("No results found.");
...
//     if (!place.geometry) {
//       setError("No geometry found for selected place.");
//       return;
//     }
...
//               <path
//                 d="M18.2657 1.98829L1.98469 8.31429L6.81369 10.3203C8.22502 10.9061 9.34636 12.0278 9.93169 13.4393L11.9377 18.2673L18.2657 1.98829Z"
//                 fill="#009689"
//               />
//             </svg>
//             Use Current Location
