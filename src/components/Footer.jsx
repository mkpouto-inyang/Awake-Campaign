          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex gap-4 max-w-2xl mx-auto">
              <input
                ...
                className="flex-[1.5] px-8 py-3 rounded-lg bg-text-grey-dark text-white placeholder-text-grey-middle border-none focus:outline-none focus:ring-2 focus:ring-teal-primary"
              />
              <Button
                variant="primary"
                className="bg-teal-primary hover:bg-teal-dark text-white px-2 py-3 rounded-lg font-medium flex-[0.6]"
              >
                Subscribe
              </Button>
            </div>
      ...
      <div className="border-t max-w-7xl py-8 mx-auto border-text-grey-dark">
        <div className="max-w-7xl mx-auto px-5 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-text-grey-light">
              <span className="mr-4">#AWAKE</span>
              <span className="mr-4">#IamAwake</span>
              <span>#IamAwakeToCervicalCancer</span>
            </div>
            <div className="text-text-grey-light">
